...
const Footer = () => {
  return (
    ...
    //     <div>
    //       <span className="footer-title table-footer-group">خدمات</span>
    //       <a className="link link-hover">نمونه کارها</a>
    //       <a className="link link-hover">واقعیت افزوده و مجازی</a>
    //       <a className="link link-hover">بازرگانی محصول</a>
    ...
    //       <a className="link link-hover">جایگاه های شغلی</a>
    //       <a className="link link-hover">اخبار</a>
    //     </div>
    //     <div>
    //       <span className="footer-title">قوانین</span>
    //       <a className="link link-hover">قوانین استفاده</a>
    //       <a className="link link-hover">سیایت های حریم مشتری</a>
