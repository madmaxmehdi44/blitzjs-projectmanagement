...
const AboutUs: BlitzPage = () => {
  return (
    <>
      ...
      <div dir="rtl" id="team" className=" relative pt-20 pb-8 md:pt-16 ">
        <div className="container xl:max-w-6xl mx-auto px-4">
          {/* // <!-- section header --> */}
          <div className="text-center mx-auto mb-12">
            <h2 className="text-2xl leading-normal mb-2 font-bold ">
              <span className="font-light">تیم</span> آرپوت
            </h2>
            <svg
              version="1.1"
          ...
          <div className="flex flex-wrap flex-row -mx-4 justify-center">
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6 ">
              <div
                className="visible duration-1000 hover:animate-pulse shadow-2xl hover:scale-110 cursor-pointer relative overflow-hidden  mb-12 hover-grayscale-0 wow fadeInUp"
              ...
              >
                ...
                <div className="relative overflow-hidden">
                  <Image
                    ...
                    // src={avatar1}
                    className="max-w-full max-h-full mx-auto rounded-full border-2 border-slate-900 overflow-clip"
                    width={300}
                    height={300}
                    alt="مهدی جلالی"
                  />
                ...
                <div className="pt-6 text-center">
                  <p className="text-lg leading-normal font-bold mb-1">مهدی جلالی</p>
            ...
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
              ...
              >
                ...
                <div className="pt-6 text-center">
                  <p className="text-lg leading-normal font-bold mb-1">مهدی زاده مینایی</p>
            ...
            <div className="flex-shrink max-w-full px-4 w-2/3 sm:w-1/2 md:w-5/12 lg:w-1/4 xl:px-6">
              ...
              >
                ...
                <div className="pt-6 text-center">
                  <p className="text-lg leading-normal font-bold mb-1">مجتبی محبی زاده</p>
